...
// New App Logo: Abstract Cat (left) & Dog (right) combination
export const AppLogoIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className}>
    <rect width="24" height="24" rx="6" fill="#2563EB" />
    <path 
      d="M6 14C6 14 5 11 7 9C8 8 9 9 10 11C11 13 12 13 12 13C12 13 13 13 14 11C15 9 17 8 18 10C19 12 18 14 18 14" 
      stroke="white" 
      strokeWidth="2" 
      strokeLinecap="round" 
      strokeLinejoin="round" 
    />
    <path d="M8 14C8 14 8.5 15.5 10 15.5C11.5 15.5 12 14 12 14" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M12 14C12 14 12.5 15.5 14 15.5C15.5 15.5 16 14 16 14" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    <circle cx="9" cy="11.5" r="0.5" fill="white" />
    <circle cx="15" cy="11.5" r="0.5" fill="white" />
  </svg>
);

// New Circular Share Wall Icon (Similar to App Logo but Circle)
export const ShareWallIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className}>
...
export const MomentsIcon = ({ className }: { className?: string }) => (
...
export const KeyboardIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect width="20" height="16" x="2" y="4" rx="2"/><path d="M6 8h.001"/><path d="M10 8h.001"/><path d="M14 8h.001"/><path d="M18 8h.001"/><path d="M6 12h.001"/><path d="M10 12h.001"/><path d="M14 12h.001"/><path d="M18 12h.001"/><path d="M7 16h10"/></svg>
);

export const WaveformIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M3 10v4"/><path d="M7 6v12"/><path d="M11 2v20"/><path d="M15 6v12"/><path d="M19 10v4"/></svg>
);
...
export const RepeatIcon = ({ className, filled }: { className?: string, filled?: boolean }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={filled ? "currentColor" : "currentColor"} strokeWidth={filled ? "3" : "2"} strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m17 2 4 4-4 4"/><path d="M3 11v-1a4 4 0 0 1 4-4h14"/><path d="m7 22-4-4 4-4"/><path d="M21 13v1a4 4 0 0 1-4 4H3"/></svg>
);
...
export const MessageSquareIcon = ({ className, filled }: { className?: string, filled?: boolean }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
);
...
export const CheckBadgeIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2z" className="text-blue-600 dark:text-blue-400" fill="currentColor" stroke="none" />
...
export const IdCardIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect width="18" height="14" x="3" y="5" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m15 14-2.5-3.5"/><path d="M9 17v-1"/></svg>
);
...
export const AppleIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.127 3.675-.552 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.065 2.09-.99 3.91-.99 1.832 0 2.303.99 3.86.99 1.605.053 2.647-1.456 3.631-2.806 1.135-1.617 1.6-3.256 1.611-3.323-.039-.01-3.115-1.182-3.135-4.69-.02-2.932 2.418-4.321 2.518-4.372-1.364-1.99-3.48-2.218-4.23-2.252-1.891-.08-3.487 1.118-4.555 1.118zm1.03-3.863c.848-1.027 1.414-2.452 1.258-3.864-1.222.048-2.698.811-3.568 1.826-.776.896-1.465 2.333-1.295 3.714 1.36.105 2.753-.655 3.605-1.676z" />
  </svg>
);
...
export const HandRockIcon = ({ className }: { className?: string }) => (
...
export const FingerPrintIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M5 15.1A2 2 0 0 0 9.1 16a2 2 0 0 0-1-3.8c-1.1 0-2.3-.2-3.4-.6" />
    <path d="M12 22a10 10 0 0 0 10-10c0-1.7-.5-3.3-1.4-4.8" />
    <path d="M16 12a2 2 0 0 0 1-3.8c-1.1 0-2.3-.2-3.4-.6" />
    <path d="M8 12a2 2 0 0 0-1 3.8c1.1 0 2.3.2 3.4.6" />
    <path d="M12 16a2 2 0 0 0 1 3.8c1.1 0 2.3.2 3.4.6" />
  </svg>
);
